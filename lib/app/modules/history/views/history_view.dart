  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Answered quiz', style: TextStyle(color: AppTheme.black, fontSize: 16,)),
        centerTitle: true,
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        child: Padding(
                          ...
                          child: Text(
                            "Done",
                            style: Theme.of(context).textTheme.headline2!.copyWith(color:Colors.black54, fontSize: 15,)
                          ),
                        ),
                        style: ButtonStyle(
